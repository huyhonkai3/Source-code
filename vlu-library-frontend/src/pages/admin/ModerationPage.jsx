...
/**
 * ModerationPage Component
 * Trang kiểm duyệt tài liệu cho Admin/Moderator
 * - Admin: Sử dụng AdminSidebar
 * - Moderator: Sử dụng UserSidebar với menu Duyệt tài liệu
 */
const ModerationPage = () => {
  ...
  const fetchStatusCounts = async () => {
    try {
      // getAllAdmin() supports all statuses (pending, approved, rejected)
  ...
  const renderSidebar = () => {
    ...
    if (isModerator) {
      return <UserSidebar active="moderation" />;
    }
          ...
          <Grid item xs={12} md={9}>
            <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
              ...
              <ModerationTable
                ...
                userRole={user?.role} // Pass role to table for conditional rendering
              />
            </Box>
          </Grid>
        </Grid>
